...
import { ResponsiveContainer, LineChart, Line, XAxis, YAxis, Tooltip, CartesianGrid } from "recharts";
  ...
  return <div className="space-y-6 text-slate-800 dark:text-white">
    ...
    /* Date navigators */
        ...
        <div className="flex items-center space-x-3 bg-slate-50 dark:bg-[#1a1a1a] border border-slate-200 dark:border-[#2a2a2a] p-1.5 rounded-xl text-xs font-semibold text-slate-700 dark:text-gray-300">
          <button
    onClick={handlePrevWeek}
    className="p-1 px-2.5 bg-white dark:bg-[#222] hover:bg-slate-100 dark:hover:bg-[#333] hover:text-slate-900 dark:hover:text-white rounded-lg transition-all cursor-pointer border border-slate-200 dark:border-[#333]"
  ...
  >
          ...
          <button
    onClick={handleToday}
    className="p-1 px-3 bg-white dark:bg-[#222] hover:bg-slate-100 dark:hover:bg-[#333] hover:text-slate-900 dark:hover:text-white rounded-lg transition-all cursor-pointer border border-slate-200 dark:border-[#333]"
  >
            Today
          </button>
