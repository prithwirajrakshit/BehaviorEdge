...
import { Database, FileSpreadsheet, Trash2, AlertTriangle, Sliders } from "lucide-react";
...
export default function SettingsView({ trades, onClearAll, showToast, onExportCSV }) {
  ...
  const handleSaveRiskSettings = (e) => {
    ...
    showToast("✅ Confluence Weights updated successfully!", "success");
  };
    ...
    <div className="max-w-3xl mx-auto space-y-8 pb-12 text-slate-800 dark:text-white animate-fade-in">
      ...
      <div className="bg-white dark:bg-[#0e0b18]/65 border border-slate-200 dark:border-violet-500/15 p-6 rounded-2xl flex flex-col md:flex-row justify-between items-start md:items-center shadow-md dark:shadow-lg gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-gray-500 italic mt-1">Configure confluence model weights and system data backups.</p>
        </div>
      </div>
      ...
      {/* SECTION 2: Confluence Alignment Model Weights */}
      <div className="bg-white dark:bg-[#0e0b18]/65 border border-slate-200 dark:border-violet-500/15 rounded-2xl p-6 shadow-md dark:shadow-xl space-y-6">
        <div className="flex items-center space-x-3 border-b border-slate-150 dark:border-[#222] pb-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-gray-400">Set percentage weights for confluences used in discipline score analytics (must sum up exactly to 100%).</p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-slate-50 dark:bg-[#121212] border border-slate-200 dark:border-violet-500/15 focus:border-violet-500 dark:focus:border-violet-500/50 rounded-xl p-2.5 text-xs text-slate-800 dark:text-white font-mono"
              />
            </div>
